 ...
 *
 * @module     theme_boost_unitec_tepukenga_dark/drawers
 ...
 * {@link module:theme_boost_unitec_tepukenga_dark/drawers#eventTypes eventTypes} object.
 *
 * @example <caption>Standard usage</caption>
 *
 * // The module just needs to be included to add drawer support.
 * import 'theme_boost_unitec_tepukenga_dark/drawers';
 *
 * @example <caption>Manually open or close any drawer</caption>
 *
 * import Drawers from 'theme_boost_unitec_tepukenga_dark/drawers';
 *
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_boost_unitec_tepukenga_dark/drawers:show}
     * @property {String} drawerShown See {@link event:theme_boost_unitec_tepukenga_dark/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_boost_unitec_tepukenga_dark/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_boost_unitec_tepukenga_dark/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_boost_unitec_tepukenga_dark/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_boost_unitec_tepukenga_dark/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_boost_unitec_tepukenga_dark/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_boost_unitec_tepukenga_dark/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_boost_unitec_tepukenga_dark/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_boost_unitec_tepukenga_dark/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_boost_unitec_tepukenga_dark/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_boost_unitec_tepukenga_dark/drawers:hidden',
    };
     ...
     * @returns {module:theme_boost_unitec_tepukenga_dark/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_boost_unitec_tepukenga_dark/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_boost_unitec_tepukenga_dark/drawers:close');
     ...
     *
     * @param {module:theme_boost_unitec_tepukenga_dark/drawers} comparisonInstance
     */
