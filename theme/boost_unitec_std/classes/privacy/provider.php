...
/**
 * Privacy Subsystem implementation for theme_boost_unitec_std.
 *
...
namespace theme_boost_unitec_std\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_boost_unitec_std');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_boost_unitec_std');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_boost_unitec_std',
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_boost_unitec_std');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_boost_unitec_std');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_boost_unitec_std',
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_boost_unitec_std');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_boost_unitec_std');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_boost_unitec_std',
